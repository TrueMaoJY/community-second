<template>
  <el-dialog
    ...
    <el-form-item label="" prop="entityType">
      <el-input v-model="dataForm.entityType" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="entityId">
      <el-input v-model="dataForm.entityId" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="targetId">
      <el-input v-model="dataForm.targetId" placeholder=""></el-input>
    </el-form-item>
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.entityType = data.comment.entityType
                this.dataForm.entityId = data.comment.entityId
                this.dataForm.targetId = data.comment.targetId
          ...
          if (valid) {
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'entityType': this.dataForm.entityType,
